App {
    ...
    Ebook {
        ...
        Chapter {name: "Was ist eine DAO? – Die neue Art der Zusammenarbeit" src: "dao.sml"}
        Chapter {name: "Das Wohnraum-DAO – Freies Wohnen ohne Miete und Bürokratie" src: "housing.sml"}
        Chapter {name: "Wer bin ich? Das spielt keine Rolle" src: "about.sml"}
    }
    ...
    Ebook {
        ...
        Chapter {name: "What is a DAO? – A New Way to Work Together" src: "dao.sml"}
        Chapter {name: "The Housing DAO – Free Housing Without Rent or Bureaucracy" src: "housing.sml"}
        Chapter {name: "Who Am I? That Doesn't Matter." src: "about.sml"}
    }
